...
pytest --cov=./f1_api --cov-report=term-missing tests

# Generate HTML coverage report
pytest --cov=./f1_api --cov-report=html tests
# Open htmlcov/index.html in your browser

# Show coverage for specific file
pytest --cov=./f1_api/services/cache.py tests/services/test_cache.py
```
...
```python
@pytest.mark.asyncio
@patch('f1_api.providers.cache.get_cached')
...
async def test_cache_set_and_get():
    ...
    from f1_api.providers.cache import set_cached, get_cached
...
def test_settings_load():
    ...
    assert settings.project_name == "f1_api"
...
async def test_with_clean_cache():
    ...
    from f1_api.providers.cache import clear_cache
...
pytest --cov=./f1_api --cov-fail-under=80 tests
```
