...
- **`f1_api/conf/settings.py`**: Main Settings class
- **`f1_api/conf/cache.py`**: Cache-specific settings
- **`f1_api/conf/db.py`**: Database settings
- **`f1_api/settings.py`**: Global settings instance
...
```python
from f1_api.conf import settings
...
from f1_api.conf.settings import Settings
...
```python
from f1_api.conf.cache import CacheSettings
