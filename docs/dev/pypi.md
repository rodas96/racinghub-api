...
[project]
name = "f1_api"
description = "Formula 1 api. Historical and up to date data"
...
# Install from wheel
pip install dist/f1_api-*.whl

# Verify installation
python -c "import f1_api; print(f1_api.__version__)"
...
1. Go to your project page: `https://pypi.org/project/f1_api/`
...
```bash
# View on PyPI
open https://pypi.org/project/f1_api/
