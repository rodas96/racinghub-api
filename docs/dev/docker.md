...
docker build -f dockerfile.www -t f1_api-www:latest .

# Tag for registry
docker tag f1_api-www:latest ghcr.io/your-org/f1_api-www:latest

# Push to registry
docker push ghcr.io/your-org/f1_api-www:latest
```
...
# Run a command
docker-compose exec www python -m f1_api.cli version

# Check database connection
docker-compose exec www python -c "from f1_api.providers.db import engine; print(engine)"
```
...
3. Images are pushed to `ghcr.io/EXAMPLE/f1_api`

### Pull Images from Registry

```bash
# Pull latest image
docker pull ghcr.io/EXAMPLE/f1_api-www:latest

# Pull specific version
docker pull ghcr.io/EXAMPLE/f1_api-www:v1.2.3

# Use in docker-compose
services:
  www:
    image: ghcr.io/EXAMPLE/f1_api-www:latest
```
